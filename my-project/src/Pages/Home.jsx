    ...
    <div>
      ...
      >
        <section className="relative z-10 xl:w-2/5 flex flex-col justify-center items-start px-8 pt-28">
          ...
          <Link to="/register">
            <button className="flex justify-center items-center gap-2 px-7 py-4 border-none text-lg leading-none rounded-full bg-[red] text-[white]  transition-transform duration-300 hover:scale-110">
              Shop now
